# -*- coding: utf-8 -*-
"""Font discovery and reusable Scribus styles for Generator v0.3.0."""
...
def create_paragraph_styles():
    ...
    definitions = [
        dict(name="Abden Body", linespacingmode=0, linespacing=t["body_leading"],
             alignment=3, firstindent=mm5, gapbefore=0.0, gapafter=0.0,
             charstyle="Abden Body Character"),
        dict(name="Abden Body First", linespacingmode=0, linespacing=t["body_leading"],
             alignment=3, firstindent=0.0, gapbefore=0.0, gapafter=0.0,
             charstyle="Abden Body Character"),
        dict(name="Abden Chapter Number", linespacingmode=0,
             linespacing=t["chapter_number_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=8.0,
             charstyle="Abden Chapter Number Character"),
        dict(name="Abden Chapter Title", linespacingmode=0,
             linespacing=t["chapter_title_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=20.0,
             charstyle="Abden Chapter Title Character"),
        dict(name="Abden Heading 1", linespacingmode=0,
             linespacing=t["heading_1_leading"], alignment=0,
             firstindent=0.0, gapbefore=14.0, gapafter=6.0,
             charstyle="Abden Heading 1 Character"),
        dict(name="Abden Heading 2", linespacingmode=0,
             linespacing=t["heading_2_leading"], alignment=0,
             firstindent=0.0, gapbefore=11.0, gapafter=4.0,
             charstyle="Abden Heading 2 Character"),
        dict(name="Abden Heading 3", linespacingmode=0,
             linespacing=t["heading_3_leading"], alignment=0,
             firstindent=0.0, gapbefore=9.0, gapafter=3.0,
             charstyle="Abden Heading 3 Character"),
        dict(name="Abden Figure Caption", linespacingmode=0,
             linespacing=t["caption_leading"], alignment=0,
             firstindent=0.0, gapbefore=4.0, gapafter=8.0,
             charstyle="Abden Caption Character"),
        dict(name="Abden Table Caption", linespacingmode=0,
             linespacing=t["caption_leading"], alignment=0,
             firstindent=0.0, gapbefore=4.0, gapafter=8.0,
             charstyle="Abden Caption Character"),
        dict(name="Abden Figure Source", linespacingmode=0,
             linespacing=t["footnote_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=0.0,
             charstyle="Abden Figure Source Character"),
        dict(name="Abden Footnote", linespacingmode=0,
             linespacing=t["footnote_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=2.0,
             charstyle="Abden Footnote Character"),
        dict(name="Abden Running Header", linespacingmode=0,
             linespacing=t["running_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=0.0,
             charstyle="Abden Running Header Character"),
        dict(name="Abden Page Number Left", linespacingmode=0,
             linespacing=t["running_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=0.0,
             charstyle="Abden Page Number Character"),
        dict(name="Abden Page Number Right", linespacingmode=0,
             linespacing=t["running_leading"], alignment=2,
             firstindent=0.0, gapbefore=0.0, gapafter=0.0,
             charstyle="Abden Page Number Character"),
        dict(name="Abden Quote", linespacingmode=0,
             linespacing=t["quote_leading"], alignment=0,
             leftmargin=mm10, rightmargin=mm10, firstindent=0.0,
             gapbefore=8.0, gapafter=8.0,
             charstyle="Abden Quote Character"),
        dict(name="Abden Archive Reference", linespacingmode=0,
             linespacing=t["archive_leading"], alignment=0,
             leftmargin=mm7, rightmargin=mm7, firstindent=0.0,
             gapbefore=6.0, gapafter=6.0,
             charstyle="Abden Archive Character"),
        dict(name="Abden Reconstruction Note", linespacingmode=0,
             linespacing=t["body_leading"], alignment=0,
             leftmargin=mm7, rightmargin=mm7, firstindent=0.0,
             gapbefore=8.0, gapafter=8.0,
             charstyle="Abden Note Character"),
        dict(name="Abden Evidence Assessment", linespacingmode=0,
             linespacing=t["body_leading"], alignment=0,
             leftmargin=mm7, rightmargin=mm7, firstindent=0.0,
             gapbefore=8.0, gapafter=8.0,
             charstyle="Abden Note Character"),
        dict(name="Abden Appendix Heading", linespacingmode=0,
             linespacing=t["chapter_title_leading"], alignment=0,
             firstindent=0.0, gapbefore=0.0, gapafter=20.0,
             charstyle="Abden Chapter Title Character"),
        dict(name="Abden Bibliography Entry", linespacingmode=0,
