#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Proof test for the C-Contents master and editable TOC-ready frame."""
...
from abden_layout import create_contents_page
...
def main():
    ...
    create_master_pages()
    scribus.applyMasterPage(MASTER_PAGES["contents"], 1)
    create_contents_page(page=1)
    scribus.gotoPage(1)
    scribus.redrawAll()

    scribus.messageBox(
        "Abden Contents Test v0.3.7a",
        "Check that the Contents heading and entries lie within the right-page margins, "
        "page numbers align at the right edge, and the master-page number appears outside "
        "at the bottom-right.",
